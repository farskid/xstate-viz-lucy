var Module = (function () {
  ...
  return function (Module) {
    ...
    if (!Object.getOwnPropertyDescriptor(Module["ready"], "_compile_xstate")) {
      Object.defineProperty(Module["ready"], "_compile_xstate", {
        configurable: true,
        get: function () {
          abort(
            "You are getting _compile_xstate on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js"
          );
        },
      });
      Object.defineProperty(Module["ready"], "_compile_xstate", {
        ...
        set: function () {
          abort(
            "You are setting _compile_xstate on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js"
          );
        },
      });
    }

    if (!Object.getOwnPropertyDescriptor(Module["ready"], "_xs_get_js")) {
      Object.defineProperty(Module["ready"], "_xs_get_js", {
        configurable: true,
        get: function () {
          abort(
            "You are getting _xs_get_js on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js"
          );
        },
      });
      Object.defineProperty(Module["ready"], "_xs_get_js", {
        ...
        set: function () {
          abort(
            "You are setting _xs_get_js on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js"
          );
        },
      });
    }

    if (!Object.getOwnPropertyDescriptor(Module["ready"], "_xs_init")) {
      Object.defineProperty(Module["ready"], "_xs_init", {
        configurable: true,
        get: function () {
          abort(
            "You are getting _xs_init on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js"
          );
        },
      });
      Object.defineProperty(Module["ready"], "_xs_init", {
        ...
        set: function () {
          abort(
            "You are setting _xs_init on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js"
          );
        },
      });
    }

    if (!Object.getOwnPropertyDescriptor(Module["ready"], "_xs_create")) {
      Object.defineProperty(Module["ready"], "_xs_create", {
        configurable: true,
        get: function () {
          abort(
            "You are getting _xs_create on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js"
          );
        },
      });
      Object.defineProperty(Module["ready"], "_xs_create", {
        ...
        set: function () {
          abort(
            "You are setting _xs_create on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js"
          );
        },
      });
    }
    ...
    if (
      !Object.getOwnPropertyDescriptor(
        Module["ready"],
        "_destroy_xstate_result"
      )
    ) {
      Object.defineProperty(Module["ready"], "_destroy_xstate_result", {
        configurable: true,
        get: function () {
          abort(
            "You are getting _destroy_xstate_result on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js"
          );
        },
      });
      Object.defineProperty(Module["ready"], "_destroy_xstate_result", {
        ...
        set: function () {
          abort(
            "You are setting _destroy_xstate_result on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js"
          );
        },
      });
    }
    ...
    Module.locateFile = function (pth) {
      ...
      switch (pth) {
        case "liblucy-debug.wasm": {
          url = new URL("./liblucy-debug.wasm", import.meta.url);
          break;
        }
        case "liblucy-release.wasm": {
          url = new URL("./liblucy-release.wasm", import.meta.url);
          break;
        }
      }
    ...
    if (ENVIRONMENT_IS_NODE) {
      if (ENVIRONMENT_IS_WORKER) {
        scriptDirectory = path.dirname(scriptDirectory) + "/";
      } else {
        scriptDirectory = new URL(import.meta.url) + "/";
      }
    ...
    var wasmBinaryFile = "liblucy-debug.wasm";
    ...
    /** @type {function(...*):?} */
    var _xs_create = (Module["_xs_create"] = createExportWrapper("xs_create"));

    /** @type {function(...*):?} */
    var _xs_init = (Module["_xs_init"] = createExportWrapper("xs_init"));

    /** @type {function(...*):?} */
    var _compile_xstate = (Module["_compile_xstate"] = createExportWrapper(
      "compile_xstate"
    ));

    /** @type {function(...*):?} */
    var _xs_get_js = (Module["_xs_get_js"] = createExportWrapper("xs_get_js"));

    /** @type {function(...*):?} */
    var _destroy_xstate_result = (Module[
      "_destroy_xstate_result"
    ] = createExportWrapper("destroy_xstate_result"));
